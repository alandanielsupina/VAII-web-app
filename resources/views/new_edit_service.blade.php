        ...
        <div class="col-6 offset-3">
            ...
            <form action="{{ route('new_services.update', $service->id) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" value="{{ $service->name }}" class="form-control" id="name" name="name" placeholder="Vložte názov služby" required>
                </div>
                <div class="form-group mb-3">
                    <label for="company_name">Názov podniku:</label>
                    <input type="text" value="{{ $service->company_name }}" class="form-control" id="company_name" name="company_name" placeholder="Vložte názov podniku" required>
                </div>
                <div class="form-group mb-3">
                    <label for="city_name">Názov mesta:</label>
                    <input type="text" value="{{ $service->city_name }}" class="form-control" id="city_name" name="city_name" placeholder="Vložte názov mesta" required>
                </div>
